...
This repository contains an end-to-end multi-modal evidence review pipeline designed to verify damage claims. The system relies on Vision-Language Models (Claude 4.6 Sonnet) augmented with deterministic rule engines to process text claims alongside multiple image attachments.
